 ...
 * Automatically POSTs new MedicationStatements and PUTs updates. Seamlessly handles duplicates.
 * 
...
if (isset($options['help'])) {
    ...
    Cron (every hour):
      15 * * * * cd /path/to/php-service && php satusehat_medicationstatement_sync.php
