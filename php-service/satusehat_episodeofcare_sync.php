...
<?php
/**
 * SIMRS Khanza - Satu Sehat Episode of Care Sync Service
 *
 * CLI service to synchronize patient Episode of Care data with BPJS Satu Sehat API.
 * Automatically maps ICD-10 diagnosis codes to ANC or TB-SO episodes, POSTs them,
 * and seamlessly handles duplicates. It also PUTs 'finished' status when the patient checks out.
 * 
...
define('SERVICE_NAME', 'KhanzaSatuSehatEpisodeOfCareSync');
...
if (isset($options['help'])) {
    ...
    Cron (every 5 minutes):
      */5 * * * * cd /path/to/php-service && php satusehat_episodeofcare_sync.php
...
$log->info("══════════════════════════════════════════════════════════════");
$log->info("  SIMRS Khanza - Satu Sehat Episode of Care Sync Service");
