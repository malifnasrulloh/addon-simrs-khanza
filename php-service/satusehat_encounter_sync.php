 ...
 *
 * CLI service to synchronize patient Encounter data with BPJS Satu Sehat API.
 * Automatically handles Arrived, In-Progress, and Finished states based on SIMRS timestamps.
 * 
...
if (isset($options['help'])) {
    ...
    Cron (every 5 minutes):
      */5 * * * * cd /path/to/php-service && php satusehat_encounter_sync.php
