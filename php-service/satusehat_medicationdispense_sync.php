 ...
 *
 * CLI service to synchronize drug dispenses (non-racikan) with Satu Sehat API.
 * Automatically POSTs new MedicationDispenses and PUTs updates. Seamlessly handles duplicates.
 * 
...
if (isset($options['help'])) {
    ...
    Cron (every hour):
      10 * * * * cd /path/to/php-service && php satusehat_medicationdispense_sync.php
