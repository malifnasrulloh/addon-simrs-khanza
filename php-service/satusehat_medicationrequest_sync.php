 ...
 *
 * CLI service to synchronize drug prescriptions (non-racikan and racikan) with Satu Sehat API.
 * Automatically POSTs new MedicationRequests and PUTs updates. Seamlessly handles duplicates.
 * 
...
if (isset($options['help'])) {
    ...
    Cron (every hour):
      5 * * * * cd /path/to/php-service && php satusehat_medicationrequest_sync.php
