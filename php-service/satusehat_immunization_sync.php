 ...
 *
 * CLI service to synchronize patient immunization / vaccine data with Satu Sehat API.
 * Automatically POSTs new immunizations and PUTs updates. Seamlessly handles duplicates.
 * 
...
if (isset($options['help'])) {
    ...
    Cron (every 5 minutes):
      */5 * * * * cd /path/to/php-service && php satusehat_immunization_sync.php
