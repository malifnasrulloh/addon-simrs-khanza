 ...
 *
 * CLI service to synchronize patient Condition (Diagnosis) data with BPJS Satu Sehat API.
 * Automatically POSTs new diagnoses and PUTs updates. Seamlessly handles duplicates.
 * 
...
if (isset($options['help'])) {
    ...
    Cron (every 5 minutes):
      */5 * * * * cd /path/to/php-service && php satusehat_condition_sync.php
