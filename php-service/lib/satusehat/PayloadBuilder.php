...
class SatuSehatPayloadBuilder
{
     ...
     */
    public static function mapIcd10(string $code): string
    {
        ...
        // Fix unpunctuated 4-character codes (e.g. E870 -> E87.0, P000 -> P00.0, E887 -> E88.7)
        if (preg_match('/^([A-Z]\d{2})(\d)$/', $code, $m)) {
            $code = $m[1] . '.' . $m[2];
        }

        // Fix 5-character US ICD-10-CM codes (e.g. O00.81 -> O00.8, J96.90 -> J96.9)
        if (preg_match('/^([A-Z]\d{2}\.\d)\d$/', $code, $m)) {
            $code = $m[1];
        }
        ...
        $map = [
            ...
            // Hemorrhoid (K64 series -> WHO ICD-10 2010 I84 series)
            'K64'   => 'I84.9',
            'K64.0' => 'I84.0',
            'K64.1' => 'I84.1',
            'K64.2' => 'I84.2',
            ...
            'K64.5' => 'I84.5',
            'K64.8' => 'I84.8',
            'K64.9' => 'I84.9',  // Haemorrhoid unspecified -> Haemorrhoid unspecified
            // Respiratory
            ...
            'J96.90'=> 'J96.9',  // US 5-char extension -> 4-char WHO
            // Fever
    ...
    public static function sanitizeUcum(array $qty): array
    {
        ...
        $res = [];
        if ($value !== null && $value !== '') {
            $parsedVal = \SatuSehatNumber::parse($value);
            // SATUSEHAT Rule 10343/10356 requires decimal > 0 for dose quantity
            $res['value'] = ($parsedVal !== null && $parsedVal > 0) ? $parsedVal : 1.0;
        }
        if ($unit !== '') {
            $res['unit'] = $unit;
        }
