 ...
 *
 * CLI service to synchronize patient Medication data with Satu Sehat API.
 ...
 *   php satusehat_medication_sync.php --parallel       # Run with 4 concurrent workers
 *   php satusehat_medication_sync.php --parallel=8     # Run with 8 concurrent workers
...
define('SERVICE_NAME', 'KhanzaSatuSehatMedicationMasterSync');
...
if (isset($options['help'])) {
    ...
    Cron (every 12 hours):
      0 */12 * * * cd /path/to/php-service && php satusehat_medication_sync.php --parallel
...
$log = new Logger($config->logDir, 'satusehat_medication', $logLevel, $isVerbose);
