 ...
 *
 * CLI service to synchronize patient Procedure data with BPJS Satu Sehat API.
 * Automatically POSTs new procedures and PUTs updates. Seamlessly handles duplicates.
 * 
...
if (isset($options['help'])) {
    ...
    Cron (every 5 minutes):
      */5 * * * * cd /path/to/php-service && php satusehat_procedure_sync.php
