...
namespace SatusehatPanel\Modules\SpecimenLab;
...
class Controller extends BaseModuleController
{
    public static function list(): array
    {
        ...
        $sql = "
            SELECT 
                pl.noorder, pl.no_rawat, pl.tgl_sampel, pl.jam_sampel,
                ...
                sml.sampel_code, sml.sampel_display,
            ...
            {$where}
            ORDER BY pl.tgl_sampel DESC, pl.jam_sampel DESC
        ...
        try {
            ...
            foreach ($rows as $r) {
                ...
                $localState = self::getLocalState('specimen_lab_pk_state', $compositeKey, $r['no_rawat'], 'Specimen');
    ...
    public static function preview(string $key): array
    {
        ...
        $payloads = PayloadAdapter::build('Specimen', $noRawat, $patient, [], true);
        $found = null;
    ...
    public static function send(): array
    {
        return self::executeSend(
            ...
            function (array|string $itemKey): array {
                ...
                throw new \RuntimeException("Payload Specimen Lab {$noorder} tidak ditemukan");
            },
            function (array|string $itemKey, string $satusehatId, array $outcome): void {
                ...
                $stmt = $db->prepare("
                    INSERT INTO satu_sehat_specimen_lab (noorder, kd_jenis_prw, id_template, id_specimen)
                    VALUES (?, ?, ?, ?)
