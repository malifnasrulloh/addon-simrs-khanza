...
namespace SatusehatPanel\Modules\ObservationRadiologi;
...
class Controller extends BaseModuleController
{
    public static function list(): array
    {
        ...
        $sql = "
            SELECT 
                pr.noorder, pr.no_rawat, pr.tgl_hasil, pr.jam_hasil,
        ...
        try {
            ...
            foreach ($rows as $r) {
                ...
                $localState = self::getLocalState('observation_radiologi_state', $compositeKey, $r['no_rawat'], 'Observation');
    ...
    public static function preview(string $key): array
    {
        ...
        $payloads = PayloadAdapter::build('Observation', $noRawat, $patient, [], true);
        $found = null;
    ...
    public static function send(): array
    {
        return self::executeSend(
            ...
            function (array|string $itemKey): array {
                ...
                throw new \RuntimeException("Payload Observation Radiologi {$noorder} tidak ditemukan");
            },
