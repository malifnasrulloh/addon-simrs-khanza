...
class Controller extends BaseModuleController
{
    public static function list(): array
    {
        ...
        $sql = "
            SELECT 
                pl.noorder, pl.no_rawat, pl.tgl_permintaan, pl.jam_permintaan, pl.diagnosa_klinis,
                rp.tgl_registrasi, rp.status_bayar, rp.status_lanjut,
                pj.no_rkm_medis, pj.nm_pasien, pj.no_ktp as nik_pasien,
                pdpl.kd_jenis_prw, tl.id_template, tl.Pemeriksaan, 'pk' as variant,
        ...
        try {
            ...
            foreach ($rows as $r) {
                ...
                $localState = self::getLocalState('servicerequest_lab_pk_state', $compositeKey, $r['no_rawat'], 'ServiceRequest');
    ...
    public static function send(): array
    {
        return self::executeSend(
            ...
            function (array|string $itemKey): array {
                ...
                throw new \RuntimeException("Payload ServiceRequest Lab {$noorder} tidak ditemukan");
            },
            function (array|string $itemKey, string $satusehatId, array $outcome): void {
                ...
                $stmt = $db->prepare("
                    INSERT INTO satu_sehat_servicerequest_lab (noorder, kd_jenis_prw, id_template, id_servicerequest)
                    VALUES (?, ?, ?, ?)
